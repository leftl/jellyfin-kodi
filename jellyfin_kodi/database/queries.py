...
get_views_by_media =    """ SELECT  * 
                            ...
                            WHERE   media_type = ? 
                        """
get_items_by_media =    """ SELECT  jellyfin_id, checksum  
                            FROM    jellyfin 
                            WHERE   media_type = ?
                        """
get_version =           """ SELECT  idVersion 
                            FROM    version
                        """
get_presentation_key =  """ SELECT  jellyfin_id 
                            FROM    jellyfin 
...
add_reference_movie_obj =   [   "{Id}","{MovieId}","{FileId}","{PathId}","Movie","movie", None,"{Checksum}","{LibraryId}",
                                "{JellyfinParentId}","{PresentationKey}"
                            ]
