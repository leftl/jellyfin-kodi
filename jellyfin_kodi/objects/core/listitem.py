...
class BaseListItem(object):
    ...
    def set_art(self):
        ...
        for kodi, jellyfin in art.items():

            if jellyfin == 'Backdrop':
                self._set_art(kodi, artwork[jellyfin][0] if artwork[jellyfin] else " ")
            else:
                self._set_art(kodi, artwork.get(jellyfin, " "))
...
class Channel(BaseListItem):
    ...
    def format(self):
        ...
        self['Artwork']['Primary'] = self['Artwork']['Primary'] or "special://home/addons/plugin.video.jellyfin/resources/icon.png"
        self['Artwork']['Thumb'] = self['Artwork']['Thumb'] or "special://home/addons/plugin.video.jellyfin/resources/icon.jpg"
        self['Artwork']['Backdrop'] = self['Artwork']['Backdrop'] or ["special://home/addons/plugin.video.jellyfin/resources/fanart.png"]
...
class Intro(Video):
    ...
    def format(self):
        ...
        self['Artwork']['Primary'] = self['Artwork']['Primary'] or self['Artwork']['Thumb'] or (self['Artwork']['Backdrop'][0] if len(self['Artwork']['Backdrop']) else "special://home/addons/plugin.video.jellyfin/resources/fanart.png")
...
class Trailer(Intro):
    ...
    def format(self):
        ...
        self['Artwork']['Primary'] = self['Artwork']['Primary'] or self['Artwork']['Thumb'] or (self['Artwork']['Backdrop'][0] if len(self['Artwork']['Backdrop']) else "special://home/addons/plugin.video.jellyfin/reseources/fanart.png")
...
class ListItem(object):
    ...
    ''' Translate an jellyfin item into a Kodi listitem.
