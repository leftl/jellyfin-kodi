...
class TVShows(KodiDb):
    ...
    def __init__(self, server, jellyfindb, videodb, direct_path, update_library=False, *args, **kwargs):
    ...
    def tvshow(self, item, e_item, library, pooling=None, redirect=False, *args, **kwargs):
        ...
        if not settings('syncEmptyShows.bool') and not obj['RecursiveCount']:
            ...
            TVShows(self.server, self.jellyfin, self.video, self.direct_path, False).remove(obj['Id'])
        ...
        if pooling is None:
            ...
            if obj['PresentationKey']: # 4.2.0.23+
                ...
                verify = True
                obj['Item']['Id'] = self.jellyfin_db.get_stack(obj['PresentationKey']) or obj['Id']
            ...
            if verify:
                ...
                if str(obj['Item']['Id']) != obj['Id']:
                    return TVShows(self.server, self.jellyfin, self.video, self.direct_path, False).tvshow(obj['Item'], library=obj['Library'], pooling=obj['Id'])
    ...
    def get_path_filename(self, obj):
        ...
        if self.direct_path:
            ...
            obj['TopLevel'] = "http://127.0.0.1:57578/kodi/tvshows/"
    ...
    def get_episode_path_filename(self, obj):
        ...
        if self.direct_path:
            ...
            obj['Path'] = "http://127.0.0.1:57578/kodi/tvshows/%s/" % obj['SeriesId']
            params = {
    ...
    def get_show_id(self, obj):
        ...
        if obj['ShowId'] is None:
            ...
            try:
                TVShows(self.server, self.jellyfin, self.video, self.direct_path, False).tvshow(self.server['api'].get_item(obj['SeriesId']), library=None, redirect=True)
    ...
    def remove_tvshow(self, kodi_id, item_id):
        ...
        self.jellyfin_db.remove_item_by_kodi_id(kodi_id, "tvshow")
    ...
    def remove_season(self, kodi_id, item_id):
        ...
        self.jellyfin_db.remove_item_by_kodi_id(kodi_id, "season")
    ...
    def remove_episode(self, kodi_id, file_id, item_id):
        ...
        self.jellyfin_db.remove_item_by_kodi_id(kodi_id, "episode")
