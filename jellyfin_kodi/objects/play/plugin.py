...
class PlayPlugin(Play):
    ...
    def __init__(self, params, server_id=None, *args, **kwargs):
        ...
        self.info = {
            ...
            'ServerAddress': Jellyfin(server_id)['auth/server-address'],
    ...
    def play(self, clear_playlist=False):
        ...
        window('jellyfin.playlist.start', str(self.info['Index']))
        ...
        while not window('jellyfin.playlist.ready.bool'):
            xbmc.sleep(50)
        ...
        if self.info['Intros']['Items']:
            ...
            if enabled:
                for intro in self.info['Intros']['Items']:
                    ...
                    window('jellyfin.skip.%s.bool' % intro['Id'], True)
