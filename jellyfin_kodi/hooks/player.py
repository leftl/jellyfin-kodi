...
class Player(xbmc.Player):
    ...
    ''' Basic Player class to track progress of Jellyfin content.
    ...
    def is_widget_play(self):
        return window('jellyfin.play.widget.bool')
    ...
    def onPlayBackStopped(self):
        ...
        window('jellyfin.play.reset.bool', True)
    ...
    def _get_items(self):
        ...
        '''
        items = window('jellyfin.play.json')
        count = 0
        ...
        while not items:
            ...
            if count == 5:
                LOG.info("<[ jellyfin.play empty ]")

                raise Exception('TimedOut')

            if window('jellyfin.play.reset.bool'):

                window('jellyfin.play.reset', clear=True)
    ...
    def _set_items(self, items):
        window('jellyfin.play.json', items)
    ...
    def set_item(self, file, track=True):
        ...
        try:
            ...
            for item in items:
                ...
                if items[0]['PlayOption'] != 'Addon' and not xbmc.getInfoLabel('VideoPlayer.DBID'): # prevent unknown files from picking up jellyfin files
                    return
    ...
    def onPlayBackError(self):
        ...
        item['Server'] = Jellyfin(item['ServerId']).get_client()
